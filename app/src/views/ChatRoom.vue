...
<div class="flex flex-col h-screen w-screen bg-white">
    <nut-navbar @on-click-back="router.back()" title="疫情"></nut-navbar>
    <scroll class="content" :probeType="3" :pull-up-load="true">
  <div id="chat"  class="flex flex-col mt-2 h-5/6 overflow-y-scroll space-y-3 mb-20 pb-3 ">
    ...
    <div class="other break-all mt-2 mb-1 p-2 rounded-br-none bg-blue-500 rounded-2xl text-white text-left mr-5">
      Words can't describe how beautiful you are :)hldvskglisuhvliuadsfhiu
    </div>
     <div class="other break-all mt-2  ml-5 rounded-bl-none float-none bg-gray-300 mr-auto rounded-2xl p-2">
      Words can't decsribe how ugly you are ;)lesfhkbufyhbgvsurbhl
    </div>   
        </div>
